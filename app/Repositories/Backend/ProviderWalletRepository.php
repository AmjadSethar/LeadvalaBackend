...
class ProviderWalletRepository extends BaseRepository
{
    ...
    {
        $providers = $this->user->role(RoleEnum::PROVIDER)->pluck('name', 'id');
        ...
        try {
            if ($request->consumer_id) {
                if ($request->type == 'credit') {
                    ...
                    return $wallet = $this->debitWallet($request->consumer_id, $request->balance, WalletPointsDetail::ADMIN_DEBIT, $request);
                }
            } else {
