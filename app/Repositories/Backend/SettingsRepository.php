...
class SettingsRepository extends BaseRepository
{
    ...
    public function test($request)
    {
        try {
            ...
            if ($request->email['mail_mailer'] == 'smtp' || $request->email['mail_mailer'] == 'sendmail') {
                ...
                Config::set('mail.mailers.smtp.password', $request->email['mail_password'] ?? '');
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('backend.settings.index')->with('success', __('static.settings.update_successfully'));
