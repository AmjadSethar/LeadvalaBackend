...
Route::group(['middleware' => ['localization']], function () {
    ...
    // Lead-related routes
    Route::post('lead/create', 'App\Http\Controllers\API\LeadController@createLead');
    Route::post('lead/{leadId}/update-status', 'App\Http\Controllers\API\LeadController@updateLeadStatus');
    Route::get('lead/{leadId}/status', 'App\Http\Controllers\API\LeadController@getLeadStatus');
    Route::get('lead/{leadId}/timeline', 'App\Http\Controllers\API\LeadController@getLeadTimeline');

    // categories
    Route::get('/categories', 'App\Http\Controllers\API\Category1Controller@categories');
    Route::get('/categories/{id}', 'App\Http\Controllers\API\Category1Controller@getCategoryById');
    Route::get('/getProvidersByCategory/{id}', 'App\Http\Controllers\API\Category1Controller@getProvidersByCategory');
    ...
    Route::get('payment_methods', 'App\Http\Controllers\API\PaymentMethodController@payment_methods');
