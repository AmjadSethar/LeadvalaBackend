                    ...
                    <div class="auth-card">
                        ...
                        <div class="main">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="email" name="email" id="email" class="form-control search-input" placeholder="{{ __('static.e-mail_address') }}">
                                @error('email')
                            ...
                            <div class="forgot-pass">
                                @if (Route::has('login'))                                
                                    <a href="{{ route('login') }}" class="justify-content-start">
