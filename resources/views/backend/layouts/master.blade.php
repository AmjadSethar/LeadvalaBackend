...
<head>
    ...
    <link rel="icon" href="{{ $settings['general']['favicon'] ?? asset('admin/images/faviconIcon.png') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ $settings['general']['favicon'] ?? asset('admin/images/faviconIcon.png') }}" type="image/x-icon">
    <title>@yield('title') - @isset($settings['general']['site_name']){{$settings['general']['site_name']}}@endisset {{ __('static.admin_panel') }}</title>
