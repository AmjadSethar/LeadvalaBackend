...
<div class="tab2-card">
    ...
    <div class="tab-content" id="bookingTabContent">
                                ...
                                <div class="booking-detail card">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <span>{{ $childBooking->consumer->name }}</span>
                                        </li>
                                        <li>
                                            <p>{{__('static.phone')}}:</p>
                                            <span>+{{ $childBooking->consumer->code.' '.$childBooking->consumer->phone }}</span>
                                        </li>
                                        <li>
                                            <p>{{__('static.country')}}:</p>
                                        ...
                                        <li>
                                            <p>{{__('static.city')}}:</p>
                                            <span>{{ $childBooking->consumer->getPrimaryAddressAttribute()->city }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="booking-detail card summary-detail">
                                    <div class="booking-header">
                                        ...
                                        <div class="btn-popup ms-auto mb-0">
                                            <a href="{{ route('invoice', $childBooking->booking_number)}}" class="btn">{{ __('static.booking.invoice') }}</a>
                                        </div>
                                    </div>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span>{{Helpers::getSettings()['general']['default_currency']->symbol}} {{ $childBooking->coupon_total_discount }}</span>
                                        </li>
                                        <li>
                                            <p>{{__('static.booking.service_discount')}}:</p>
                                            <span>{{Helpers::getSettings()['general']['default_currency']->symbol}} {{ $childBooking->discount ?? 0 }}</span>
                                        </li>
                                        <li>
                                            <p>{{__('static.booking.service_tax')}}:</p>
                                            <span>{{Helpers::getSettings()['general']['default_currency']->symbol}} {{ $childBooking->tax ?? 0 }}</span>
                                        </li>
                                        <li >
                                            <p>{{__('static.booking.service_amount')}}:</p>
                                            <span>{{Helpers::getSettings()['general']['default_currency']->symbol}} {{ $childBooking->service_price ?? 0 }}</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="tab-pane fade" id="booking_status" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
