                ...
                <form action="{{route('backend.paymentmethods.update', $paymentMethod['slug'])}}" id="" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xxl-8">
                            ...
                            <input class="form-control" type="password" name="{{ $fieldKey }}" id="{{ $fieldKey }}" placeholder="{{ $field['label'] }}" value="{{ $fieldValue}}">
                            @else
                            <input class="form-control" type="{{ $field['type'] }}" name="{{ $fieldKey }}" id="{{ $fieldKey }}" value="{{  $fieldValue }}" placeholder="{{ $field['label'] }}">
                            @endif
                        </div>
                    </div>
                    @endforeach
